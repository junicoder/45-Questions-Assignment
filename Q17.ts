...
console.log(
  "I just heard the new table won't arrive in time. I am sorry, guys. Let's plan some other time."
);
...
for (let i = 0; i < guestList.length; i++) {
  console.log(
    `Hello ${guestList[i]} The Plan is still good for us. Don't Forget to join.`
  );
}
